...
class RecordWindow(wx.Frame):
	def __init__(self, parent):
		...
		app_icon.CopyFromBitmap(wx.Bitmap('icon.ico', wx.BITMAP_TYPE_ANY))
		...
		self.save_button.Bind(wx.EVT_BUTTON, self.SaveRecordReport)
		...
		hor_sizer6.Add(self.add_button, 0, wx.ALL | wx.EXPAND, 5)
		hor_sizer6.AddStretchSpacer(1)
		hor_sizer6.Add(self.delete_button, 0, wx.ALL | wx.EXPAND, 5)
		hor_sizer6.AddStretchSpacer(1)
		hor_sizer6.Add(self.create_button, 0, wx.ALL | wx.EXPAND, 5)
		hor_sizer6.AddStretchSpacer(2)
		hor_sizer6.Add(self.save_button, 0, wx.ALL | wx.EXPAND, 5)
		hor_sizer6.AddStretchSpacer(2)

		vert_sizer1.Add(self.list_ctrl, 1, wx.ALL |  wx.GROW)
